...
const Navegation = ({ theme, handleChangeTheme }) => {
  ...
  return (
    <nav className="fixed w-full contenedor z-50 max-sm:bottom-2 ">
      <div
        className="w-[80%] mx-auto py-5 flex justify-between dark:text-white border-b-2 px-5
      max-sm:w-full max-sm:justify-center
      "
      >
        <h2 className="font-[Roboto] font-[700] text-xl max-sm:hidden">
          Christian Peña Yañez
        </h2>
        <div className="flex gap-8">
          <ul className="flex gap-8 cursor-pointer font-[Roboto] font-[400] max-sm:text-[12px] max-sm:gap-4">
