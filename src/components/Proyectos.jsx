...
const Proyectos = () => {
  return (
    <section className="min-h-[90vh]">
      <div className="w-[80%] mx-auto h-full max-sm:w-[90%] max-lg:w-[90%] max-sm:mt-16 max-lg:mt-16 ">
        <motion.h2
          variants={fadeIn("right", 0.2)}
          initial={{ opacity: 0 }}
          whileInView={"show"}
          viewport={{ once: false, amount: 0.7 }}
          className="text-5xl font-[Lato] font-[900] max-sm:text-2xl max-lg:text-center max-lg:text-3xl "
        >
          Proyectos
        </motion.h2>
              ...
              <div className="flex flex-col justify-center gap-2">
                ...
                <div>
                  {proyecto.technologies.map((tecnologia) => (
                    <span key={tecnologia} className="text-[#a7a8a9] font-[Roboto] font-[300]">
                      {tecnologia}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex gap-5 max-sm:justify-center">
                  <a
                    className="py-2 px-9 rounded-md border-[#333c43] shadow-lg font-[Roboto] font-[400] dark:hover:bg-[#1a2123] max-md:px-5 dark:border-2"
                    target="_blank"
                    href={proyecto.deploid.gitHud}
                  >
                    Git Hub
                  </a>
                  {proyecto.deploid.deploy && (
                    <a
